...
def test_model(is_last):
    ...
    if is_last == "last":
        f = open('Resnet18_NotPretrained.txt', 'w')
        f.write("[")
...
def train_model():
    for epoch in range(10):
        ...
        if epoch == 9:
            Train_acc, Test_acc = test_model("last")
        else:
            Train_acc, Test_acc = test_model("notlast")
